...
Full-stack developer and designer with an MSc in Advanced Computer Science from the University of Chester. I build things end to end, from backend logic and APIs through to the interface people actually use, and I do the design work around them too.
...
**Design:** `Logo & identity` `UI/UX` `Wireframing` `Brand systems` `Graphic design`
